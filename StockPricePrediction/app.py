...
# Ensure the static directory exists for saving files
...
try:
    ...
    raise FileNotFoundError("The model file 'stock_dl_model.h5' was not found. Please ensure it is in the correct directory.")

# Inside your POST request route, replace:
